...
describe("With Enzyme", () => {
  ...
  test("ProductDetail renders expected number of ProductItem component elements", async () => {
    const mockProductDetailApiResponse = {
      ...
      "media": {
        "images": {
          "altText": "Buy Bosch SMS25EW00G Freestanding Dishwasher, White Online at johnlewis.com",
          "urls": [
        ...
        "videos": {
          ...
          "videoHeight": "664",
          "videoWidth": "664",
          "imgAltText": "Buy Bosch SMS25EW00G Freestanding Dishwasher, White Online at johnlewis.com"
        }
      },
      "price": {
        "was": "",
        ...
        "optionalServices": [
          {
            ...
            "description": "Our electrical products are guaranteed against breakdown for a minimum of 2 years at no extra cost. With Protect Plus, you'll get up to 5 years of protection against accidental damage alongside your guarantee. <a href='https://www.johnlewis.com/protectplus'>More about Protect Plus</a>",
            "price": "100.00",
            "currency": "GBP",
            "orderOnSite": 1,
            "type": "ADDED_WARRANTY",
            "url": "/protectplus",
            "customProperties": {
              "warrantyCustomGeneric": "Exclusions apply. To make sure this policy meets your needs, please read the <a href='https://johnlewis.scene7.com/is/content/JohnLewis/IPID-Home-Appliancepdf'>Insurance Product Information Document</a>.",
    ...
    axios.get.mockResolvedValue(mockProductDetailApiResponse);
    const app = mount(<ProductDetail />);

    await waitForComponentToPaint(app);

    expect(app.find("h1").text()).toEqual("Bosch SMS25EW00G Freestanding Dishwasher, White");
